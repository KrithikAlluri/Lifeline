from PyQt5.QtWidgets import QWidget, QVBoxLayout, QLabel, QPushButton, QTableWidget, QTableWidgetItem, QHBoxLayout, QSizePolicy
...
class DashboardPage(QWidget):
    ...
    def init_ui(self):
        ...
        # Two rows of buttons, dynamic sizing
        btn_layout1 = QHBoxLayout()
        self.new_test_btn = QPushButton("Start New Test")
        self.new_test_btn.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Preferred)
        self.new_test_btn.setStyleSheet("font-size: 18px;")
        self.new_test_btn.clicked.connect(self.goto_new_test)
        btn_layout1.addWidget(self.new_test_btn)
        self.export_btn = QPushButton("Export Data")
        self.export_btn.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Preferred)
        self.export_btn.setStyleSheet("font-size: 18px;")
        btn_layout1.addWidget(self.export_btn)
        self.switch_btn = QPushButton("Switch User")
        self.switch_btn.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Preferred)
        self.switch_btn.setStyleSheet("font-size: 18px;")
        ...
        self.settings_btn.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Preferred)
        ...
        self.chatbot_btn.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Preferred)
        self.chatbot_btn.setStyleSheet("font-size: 18px;")
